...
class Payouts extends Base {
   ...
   */
  async airtime(airtimes = [], subAccount = null) {
   ...
   */
  async bank(banks = [], subAccount = null) {
   ...
   * @returns The response from the Chi Money API
   */
  async mobileMoney(momos = [], subAccount = null) {
   ...
   * @returns The response from the Chi Money API
   */
  async giftCard(giftCards = [], subAccount = null) {
   ...
   * @returns The response from the Chi Money API
   */
  async status(chiRef, subAccount = null) {
  ...
  async initiateChimoney(
    ...
    return this.client.handleRequest({
      method: HTTPMETHODS.POST,
      payload,
      path: "/payouts/initiate-chimoney",
    });
  }
}
