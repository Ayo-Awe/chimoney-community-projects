...
class MobileMoney extends Base {
  /**
  ...
  async getAllTransactions(subAccount = null) {
    ...
    return this.client.handleRequest({
      ...
      payload,
      path: "/collections/mobile-money/all",
    });
  }
   ...
   * @returns The response from the Chi Money API
   */
  async makePayment(paymentDetails, subAccount = null) {
    ...
    return this.client.handleRequest({
      method: HTTPMETHODS.POST,
      payload,
      path: "/collections/mobile-money/collect",
    });
  }
   ...
   * @returns The response from the Chi Money API
   */
  async verifyPayment(id, subAccount = null) {
    ...
    return this.client.handleRequest({
      method: HTTPMETHODS.POST,
      payload,
      path: "/collections/mobile-money/verify",
    });
  }
}
