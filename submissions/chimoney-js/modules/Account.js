...
class Account extends Base {
   ...
   */
  async getTransactionsByIssueID(issueID, subAccount = null) {
    ...
    return await this.client.handleRequest({
      method: HTTPMETHODS.POST,
      path: "/accounts/issue-id-transactions",
      params,
      payload,
    });
  }
   ...
   * @returns The response from the Chi Money API
   */
  async getAllTransactions(subAccount = null) {
    const payload = {};
   ...
   * @returns The response from the Chi Money API
   */
  async accountTransfer(receiver, amount, wallet, subAccount = null) {
   ...
   */
  async deleteUnpaidTransaction(chiRef, subAccount = null) {
    ...
    return this.client.handleRequest({
      ...
      payload,
      path: "/accounts/delete-unpaid-transaction",
    });
  }
   ...
   * @returns The response from the Chi Money API
   */
  async getTransactionByID(transctionId, subAccount = null) {
